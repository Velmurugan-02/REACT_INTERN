...
let Function_count = () =>{
    ...
    let inc_btn_1 = () => setCount_1(count_1 => count_1 + 1);
    let dec_btn_1 = () => setCount_1(count_1 => count_1 - 1);
    let inc_btn_2 = () => setCount_2(count_2 => count_2 + 1);
